...
def main():
    ...
    config_file = "sample_curobo_config_shelf_to_sink_UPDATE.yaml"
    cfg_file = load_yaml(join_path(get_world_configs_path(), config_file))
    cubes = []
    env = cfg_file['env']
    for obj in env:
    ...
    usd_help.load_stage(stage)  # loads Isaac Sim world to Curobo environment
